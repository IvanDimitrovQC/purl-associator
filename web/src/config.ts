...
export type RuntimeConfig = {
  ...
  /** Optional: dashboard payload generated by advisory:dashboard-data. */
...
const fromEnv: Partial<RuntimeConfig> = {
  ...
  dashboardDataUrl: env.VITE_DASHBOARD_DATA_URL,
...
export const config: RuntimeConfig = {
  ...
  dashboardDataUrl:
    injected.dashboardDataUrl ??
    fromEnv.dashboardDataUrl ??
    "./advisory-dashboard-data.json",
